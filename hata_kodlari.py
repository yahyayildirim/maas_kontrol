...
1- Personel, İKYS üzerinden derece/kademe terfi almış ama KBS'ye işlenmemiş olabilir.
...
ilave_odeme_hata ="""AÇIKLAMA:
1- Herhangi bir nedenle 97-İlave Ödeme (375 KHK Ek M.40) kodlu tazminat yüklenmemiş olanlar için; mutemetlerce maaş/ücret bilgi girişi ekranından ilgili kişinin bilgileri ekrana getirilerek Diğer Tazminat ekranından "97-İlave Ödeme (375 KHK Ek M.40)" tazminat kodunun eklenmesi gerekmektedir.
2- 7456 sayılı Kanunun 28 inci Maddesi ile 375 sayılı Kanun Hükmünde Kararnameye eklenen Ek 40 ıncı maddede sayılmaması nedeniyle ilave ödemeden yararlandırılmayacak personelin bilgileri mutemetlerce maaş/ücret bilgi girişi ekranından ekrana getirilerek Diğer Tazminat ekranından "97-İlave Ödeme (375 KHK Ek M.40)" tazminat kodunun silinmesi gerekmektedir.
"""
