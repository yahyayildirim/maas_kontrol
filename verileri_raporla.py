...
def raporla():
	try:
		...
		kbs_in_ikys_out.to_excel('./rapor/' + str(bu_yil) + '/' + str(bu_ay) + '/2-kbsde_olup_ikysde_olmayanlar.xlsx', index=False, header=True, freeze_panes=(1,0))
		print('%50')
		...
		ikys_in_kbs_out.to_excel('./rapor/' + str(bu_yil) + '/' + str(bu_ay) + '/3-ikysde_olup_kbsde_olmayanlar.xlsx', index=False, header=True, freeze_panes=(1,0))
		print('%70')
